...
const filteredProduct_1 = __importDefault(require("./routes/filteredProduct"));
const sendMailRouter_1 = __importDefault(require("./routes/sendMailRouter"));
...
app.use('/api/products', filteredProduct_1.default);
app.use('/api/mail', sendMailRouter_1.default);
app.use('/uploads', express_1.default.static(path_1.default.join(__dirname, 'middlewares/uploads')));
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield (0, database_1.default)();
            yield (0, cron_1.sendingEmail)();
